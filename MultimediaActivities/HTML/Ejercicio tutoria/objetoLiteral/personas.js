...
const _vi = document.getElementById("viñeta");
const _name = document.getElementById("name");
const _pic = document.getElementById("picture");
const _title = document.getElementById("title");
const _age = document.getElementById("age");
const _email = document.getElementById("email");
const _adress = document.getElementById("adress");
...
function Confirm(){
  let _text = _name.value;
  let founded = false;

  personas.forEach(item => {
    if(_text == item.name) {
      founded = true;
      _dom.setAttribute("style", "background-color:" + item.eyeColor)
      _vi.setAttribute("class", "");
      _pic.setAttribute("src", item.picture);
      _title.innerText = item.name;
      _age.innerText = item.age;
      _email.innerText = item.email;
      _adress.innerText = item.address;
    }
  });

  if (!founded) {
    window.alert("Esta persona no se encuentra en la base de datos")
  }
}
